...
Also, decimalInfinite was implemented in JSONiq \cite{decimalInfiniteJSONiq} where it was experimentally checked that the order is preserved on sample ranges.
