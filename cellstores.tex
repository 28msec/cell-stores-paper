...
Entity & Visa \\
Unit & US Dollars \\
Class of Stock & Class of Stock Domain \\
\hline\hline
...
\begin{figure}
\caption{An example of hypercube}
\label{fig-hypercube}
\begin{tabular}{l|l}
\hline
Dimension & Value \\
...
Since cells have dimensional \emph{coordinates}, they can be seen as a big data cube.
